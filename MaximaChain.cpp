...
MaximaChain::ReplyPtr MaximaChain::executeCommandRaw(
...
std::string MaximaChain::executeInteractive(const std::string &command)
{
...
void MaximaChain::setMaximaIOHook(const std::string &hookRegex,
    MaximaIOHook *hook)
{
    maximaIOHook = hook;
...
int MaximaChain::checkInputExpression(char c, int state) const
{
    /*
